...
class TodoListApp(tk.Tk):
    def __init__(self):
        ...
        ttk.Button(self, text="Add", style="info.TButton",command=self.add_task).pack(pady=5)
        ...
        ttk.Button(self, text="View Status", style="warning.TButton", command=self.view_stats).pack(side=tk.BOTTOM, pady=10)
    ...
    def add_task(self):
        ...
        if task != "Enter your todo here...":
            ...
            self.task_list.itemconfig(tk.END)
